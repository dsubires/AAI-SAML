...
$config = array(
    ...
    'default-sp' => array(
        'saml:SP',
         'privatekey' => 'idpiot.pem',
         'certificate' => 'idpiot.crt',
//    	 'certificate' => 'cafeexpresso.rnp.br.crt',
...
//	'example-multi' => array(
//		'multiauth:MultiAuth',
//                'sources' => array('example-userpass', 'deviceauthinstance'),
    ...
    */
	...
	'alumno:alumno@idp' => array(
	    'uid' => array('alumno'),
	    'mail' => array('alumno@idpiot.ual.es'),
	    'homePostalAddress' => array('PITA ALMERIA'),
	    'commonName' => array('alumno'),
	    'surName' => array('test'),
	    'eduPersonAffiliation' => array('student'), 
	),
    ),

	'deviceauthinstance' => array(
        	'deviceauth:DVC',
		'username' => 'marlon',
		'password' => 'marlon',
	),
     ...
     'x509' => array(
            ...
            'search.base' => 'dc=idp,dc=com',
            'authX509:x509attributes' => array('CN' => 'uid'),
