...
$state = SimpleSAML_Auth_State::loadState($authStateId, sspmod_core_Auth_DevicePassBase::STAGEID);


$source = SimpleSAML_Auth_Source::getById($state[sspmod_core_Auth_DevicePassBase::AUTHID]);
if ($source === NULL) {
	throw new Exception('Could not find authentication source with id ' . $state[sspmod_core_Auth_DevicePassBase::AUTHID]);
}
